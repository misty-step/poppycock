...
import { AVATAR_NAMES, avatarForSeat, type AvatarId } from "@/lib/avatars";

export const AvatarContext = createContext<Readonly<Partial<Record<string, AvatarId>>>>({});

const portraits: Record<AvatarId, ReactNode> = {
  cockatoo: (
    <>
...
export function Face({
  ...
  const selected = avatarId ?? (playerId ? choices[playerId] : undefined) ?? avatarForSeat(seat);
  return (
    <span
