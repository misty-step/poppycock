...
- **Game source:** [`b3bec52847b6b1e6132d057e8eb4c5dae2af5d6c`](https://github.com/misty-step/poppycock/commit/b3bec52847b6b1e6132d057e8eb4c5dae2af5d6c).
...
The principal screenshots and trace came from an independent clean clone of the game source commit above, with its own newly generated secrets, isolated Convex state, and no sibling Parlor checkout. The following delivery commit adds evidence/documentation and stops tracking Next's generated environment declarations; it does not change executable game behavior. Missing Next declarations were separately deleted in the clean checkout and successfully regenerated by `pnpm typecheck`.
...
No paid infrastructure or public deployment was provisioned. Local play needs no production credentials. Public hosting would require an authorized HTTPS application origin and game-owned Convex deployment with matching server-only signing configuration; no such deployment is claimed here.
